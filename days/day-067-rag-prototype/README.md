# Day 067: RAG prototype

## Goal

Understand **RAG prototype** and complete this practical task: **Answer questions from a small document set**

Your evidence for today is: **RAG prototype**

## Research Questions

- What problem does RAG prototype solve?
...
2. Complete today's task: **Answer questions from a small document set**
3. Add your **RAG prototype** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 067 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 068: Tool use and agents](../day-068-tool-use-and-agents/README.md).
