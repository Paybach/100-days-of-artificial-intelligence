# Day 068: Tool use and agents

## Goal

Understand **Tool use and agents** and complete this practical task: **Design a narrowly scoped tool-using workflow**

Your evidence for today is: **Agent diagram**

## Research Questions

- What problem does Tool use and agents solve?
...
2. Complete today's task: **Design a narrowly scoped tool-using workflow**
3. Add your **Agent diagram** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 068 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 069: Agent guardrails](../day-069-agent-guardrails/README.md).
