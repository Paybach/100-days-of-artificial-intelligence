# Day 062: Structured output

## Goal

Understand **Structured output** and complete this practical task: **Generate and validate structured model output**

Your evidence for today is: **Small prototype**
...
2. Complete today's task: **Generate and validate structured model output**
3. Add your **Small prototype** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 062 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 063: LLM evaluation](../day-063-llm-evaluation/README.md).
