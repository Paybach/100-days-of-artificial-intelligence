# Day 040: Tabular ML capstone

## Goal

Understand **Tabular ML capstone** and complete this practical task: **Package a well-evaluated tabular model**

Your evidence for today is: **Capstone project**

## Research Questions

- What problem does Tabular ML capstone solve?
...
- Suggested notebook: [Clustering and PCA](../../notebooks/04-clustering-and-pca.ipynb)
...
2. Complete today's task: **Package a well-evaluated tabular model**
3. Add your **Capstone project** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 040 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 041: Neural networks](../day-041-neural-networks/README.md).
