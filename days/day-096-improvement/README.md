...
Understand **Improvement** and complete this practical task: **Make one evidence-based improvement**

Your evidence for today is: **Comparison report**

## Research Questions

- What problem does Improvement solve?
...
2. Complete today's task: **Make one evidence-based improvement**
3. Add your **Comparison report** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 096 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 097: Packaging](../day-097-packaging/README.md).
