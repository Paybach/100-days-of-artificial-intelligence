...
Understand **Containers** and complete this practical task: **Package the model service with Docker**

Your evidence for today is: **Dockerfile**
...
2. Complete today's task: **Package the model service with Docker**
3. Add your **Dockerfile** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 073 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 074: Experiment tracking](../day-074-experiment-tracking/README.md).
