# Day 084: Explainability report

## Goal

Understand **Explainability report** and complete this practical task: **Explain predictions to a non-technical reader**

Your evidence for today is: **Explanation note**

## Research Questions

- What problem does Explainability report solve?
...
- Related milestone: [Responsible AI capstone](../../projects/project-05-responsible-ai-capstone/README.md)
...
2. Complete today's task: **Explain predictions to a non-technical reader**
3. Add your **Explanation note** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 084 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 085: Human oversight](../day-085-human-oversight/README.md).
