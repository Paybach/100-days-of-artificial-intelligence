# Day 051: Text preprocessing

## Goal

Understand **Text preprocessing** and complete this practical task: **Tokenize and inspect text data**

Your evidence for today is: **NLP notebook**
...
2. Complete today's task: **Tokenize and inspect text data**
3. Add your **NLP notebook** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 051 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 052: TF-IDF baseline](../day-052-tf-idf-baseline/README.md).
