# Day 088: AI incident response

## Goal

Understand **AI incident response** and complete this practical task: **Write a response plan for a model failure**

Your evidence for today is: **Incident plan**
...
2. Complete today's task: **Write a response plan for a model failure**
3. Add your **Incident plan** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 088 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 089: Governance](../day-089-governance/README.md).
