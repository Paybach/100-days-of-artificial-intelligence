# Day 059: RAG foundations

## Goal

Understand **RAG foundations** and complete this practical task: **Explain retrieval, context, and generation**

Your evidence for today is: **RAG diagram**

## Research Questions

- What problem does RAG foundations solve?
...
2. Complete today's task: **Explain retrieval, context, and generation**
3. Add your **RAG diagram** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 059 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 060: NLP capstone](../day-060-nlp-capstone/README.md).
