# Day 017: Loss functions

## Goal

Understand **Loss functions** and complete this practical task: **Compare regression and classification losses**

Your evidence for today is: **Loss notebook**

## Research Questions

- What problem does Loss functions solve?
...
2. Complete today's task: **Compare regression and classification losses**
3. Add your **Loss notebook** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 017 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 018: Gradient descent](../day-018-gradient-descent/README.md).
