# Day 007: Data cleaning

## Goal

Understand **Data cleaning** and complete this practical task: **Handle missing values, duplicates, and inconsistent types**

Your evidence for today is: **Cleaning notebook**

## Research Questions

- What problem does Data cleaning solve?
...
- Suggested notebook: [pandas data story](../../notebooks/02-pandas-data-story.ipynb)
...
2. Complete today's task: **Handle missing values, duplicates, and inconsistent types**
3. Add your **Cleaning notebook** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 007 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 008: Exploratory analysis](../day-008-exploratory-analysis/README.md).
