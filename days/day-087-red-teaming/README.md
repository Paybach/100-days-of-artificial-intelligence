...
Understand **Red teaming** and complete this practical task: **Test misuse, edge cases, and unsafe outputs**

Your evidence for today is: **Test log**

## Research Questions

- What problem does Red teaming solve?
...
2. Complete today's task: **Test misuse, edge cases, and unsafe outputs**
3. Add your **Test log** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 087 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 088: AI incident response](../day-088-ai-incident-response/README.md).
