# Day 054: Sequence models

## Goal

Understand **Sequence models** and complete this practical task: **Explain RNNs, LSTMs, and their tradeoffs**

Your evidence for today is: **Sequence notes**

## Research Questions

- What problem does Sequence models solve?
...
- Related milestone: [Semantic search project](../../projects/project-03-semantic-search/README.md)
- Suggested notebook: [Semantic search concepts](../../notebooks/05-semantic-search-concepts.ipynb)
...
2. Complete today's task: **Explain RNNs, LSTMs, and their tradeoffs**
3. Add your **Sequence notes** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 054 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 055: Attention and transformers](../day-055-attention-and-transformers/README.md).
