...
Understand **CI for ML** and complete this practical task: **Add automated checks for an ML project**

Your evidence for today is: **CI workflow**

## Research Questions

- What problem does CI for ML solve?
...
2. Complete today's task: **Add automated checks for an ML project**
3. Add your **CI workflow** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 078 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 079: Deployment options](../day-079-deployment-options/README.md).
