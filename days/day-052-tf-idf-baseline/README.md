# Day 052: TF-IDF baseline

## Goal

Understand **TF-IDF baseline** and complete this practical task: **Train a text classifier with TF-IDF features**

Your evidence for today is: **Baseline notebook**

## Research Questions

- What problem does TF-IDF baseline solve?
...
2. Complete today's task: **Train a text classifier with TF-IDF features**
3. Add your **Baseline notebook** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 052 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 053: Embeddings](../day-053-embeddings/README.md).
