# Day 012: Matrix operations

## Goal

Understand **Matrix operations** and complete this practical task: **Practice dot products, transpose, and matrix multiplication**

Your evidence for today is: **NumPy exercises**

## Research Questions

- What problem does Matrix operations solve?
...
2. Complete today's task: **Practice dot products, transpose, and matrix multiplication**
3. Add your **NumPy exercises** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 012 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 013: Derivatives and gradients](../day-013-derivatives-and-gradients/README.md).
