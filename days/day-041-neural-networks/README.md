# Day 041: Neural networks

## Goal

Understand **Neural networks** and complete this practical task: **Sketch layers, activations, and forward passes**

Your evidence for today is: **Network notes**

## Research Questions

- What problem does Neural networks solve?
...
2. Complete today's task: **Sketch layers, activations, and forward passes**
3. Add your **Network notes** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 041 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 042: PyTorch tensors](../day-042-pytorch-tensors/README.md).
