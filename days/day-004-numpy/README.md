...
Understand **NumPy** and complete this practical task: **Explore arrays, shapes, indexing, and vector operations**

Your evidence for today is: **NumPy notebook**
...
- Suggested notebook: [Python and NumPy practice](../../notebooks/01-python-and-numpy-practice.ipynb)
...
2. Complete today's task: **Explore arrays, shapes, indexing, and vector operations**
3. Add your **NumPy notebook** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 004 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 005: pandas](../day-005-pandas/README.md).
