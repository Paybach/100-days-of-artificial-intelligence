# Day 079: Deployment options

## Goal

Understand **Deployment options** and complete this practical task: **Compare batch, real-time, and edge inference**

Your evidence for today is: **Deployment decision**

## Research Questions

- What problem does Deployment options solve?
...
2. Complete today's task: **Compare batch, real-time, and edge inference**
3. Add your **Deployment decision** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 079 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 080: MLOps capstone](../day-080-mlops-capstone/README.md).
