# Day 044: Multilayer perceptrons

## Goal

Understand **Multilayer perceptrons** and complete this practical task: **Train an MLP classifier**

Your evidence for today is: **MLP notebook**

## Research Questions

- What problem does Multilayer perceptrons solve?
...
2. Complete today's task: **Train an MLP classifier**
3. Add your **MLP notebook** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 044 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 045: Regularization](../day-045-regularization/README.md).
