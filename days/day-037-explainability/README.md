# Day 037: Explainability

## Goal

Understand **Explainability** and complete this practical task: **Inspect feature importance or SHAP values**

Your evidence for today is: **Explanation report**
...
2. Complete today's task: **Inspect feature importance or SHAP values**
3. Add your **Explanation report** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 037 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 038: Bias and fairness](../day-038-bias-and-fairness/README.md).
