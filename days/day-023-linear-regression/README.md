# Day 023: Linear regression

## Goal

Understand **Linear regression** and complete this practical task: **Train and evaluate a scikit-learn regressor**

Your evidence for today is: **Regression notebook**
...
2. Complete today's task: **Train and evaluate a scikit-learn regressor**
3. Add your **Regression notebook** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 023 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 024: Logistic regression](../day-024-logistic-regression/README.md).
