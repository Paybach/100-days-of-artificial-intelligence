...
Understand **API testing** and complete this practical task: **Add request validation and endpoint tests**

Your evidence for today is: **Test suite**

## Research Questions

- What problem does API testing solve?
...
2. Complete today's task: **Add request validation and endpoint tests**
3. Add your **Test suite** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 072 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 073: Containers](../day-073-containers/README.md).
