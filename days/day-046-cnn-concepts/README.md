# Day 046: CNN concepts

## Goal

Understand **CNN concepts** and complete this practical task: **Explain convolution, pooling, and feature maps**

Your evidence for today is: **CNN notes**

## Research Questions

- What problem does CNN concepts solve?
...
2. Complete today's task: **Explain convolution, pooling, and feature maps**
3. Add your **CNN notes** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 046 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 047: Image augmentation](../day-047-image-augmentation/README.md).
