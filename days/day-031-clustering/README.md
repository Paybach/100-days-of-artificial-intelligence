...
Understand **Clustering** and complete this practical task: **Segment a dataset with k-means**

Your evidence for today is: **Clustering notebook**
...
2. Complete today's task: **Segment a dataset with k-means**
3. Add your **Clustering notebook** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 031 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 032: PCA](../day-032-pca/README.md).
