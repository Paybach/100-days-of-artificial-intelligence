# Day 042: PyTorch tensors

## Goal

Understand **PyTorch tensors** and complete this practical task: **Practice tensors and automatic differentiation**

Your evidence for today is: **PyTorch notebook**

## Research Questions

- What problem does PyTorch tensors solve?
...
2. Complete today's task: **Practice tensors and automatic differentiation**
3. Add your **PyTorch notebook** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 042 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 043: Training loops](../day-043-training-loops/README.md).
