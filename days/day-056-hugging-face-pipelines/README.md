# Day 056: Hugging Face pipelines

## Goal

Understand **Hugging Face pipelines** and complete this practical task: **Run a pretrained NLP model**

Your evidence for today is: **Pipeline notebook**

## Research Questions

- What problem does Hugging Face pipelines solve?
...
2. Complete today's task: **Run a pretrained NLP model**
...
- [ ] I marked Day 056 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 057: Text classification](../day-057-text-classification/README.md).
