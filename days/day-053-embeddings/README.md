...
Understand **Embeddings** and complete this practical task: **Compare text similarity with embeddings**

Your evidence for today is: **Embeddings notebook**

## Research Questions

- What problem does Embeddings solve?
...
2. Complete today's task: **Compare text similarity with embeddings**
3. Add your **Embeddings notebook** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 053 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 054: Sequence models](../day-054-sequence-models/README.md).
