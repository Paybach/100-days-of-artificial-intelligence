...
Understand **Model APIs** and complete this practical task: **Serve a simple model behind an API**

Your evidence for today is: **API project**

## Research Questions

- What problem does Model APIs solve?
...
2. Complete today's task: **Serve a simple model behind an API**
3. Add your **API project** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 071 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 072: API testing](../day-072-api-testing/README.md).
