# Day 061: Prompt fundamentals

## Goal

Understand **Prompt fundamentals** and complete this practical task: **Compare zero-shot, few-shot, and constrained prompts**

Your evidence for today is: **Prompt notes**

## Research Questions

- What problem does Prompt fundamentals solve?
...
- Related milestone: [Model API project](../../projects/project-04-model-api/README.md)
...
2. Complete today's task: **Compare zero-shot, few-shot, and constrained prompts**
3. Add your **Prompt notes** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 061 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 062: Structured output](../day-062-structured-output/README.md).
