# Day 018: Gradient descent

## Goal

Understand **Gradient descent** and complete this practical task: **Implement a simple gradient descent loop**

Your evidence for today is: **Python implementation**
...
2. Complete today's task: **Implement a simple gradient descent loop**
3. Add your **Python implementation** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 018 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 019: Linear regression from scratch](../day-019-linear-regression-from-scratch/README.md).
