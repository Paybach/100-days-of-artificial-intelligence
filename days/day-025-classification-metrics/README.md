# Day 025: Classification metrics

## Goal

Understand **Classification metrics** and complete this practical task: **Compare accuracy, precision, recall, F1, and ROC-AUC**

Your evidence for today is: **Metrics notes**

## Research Questions

- What problem does Classification metrics solve?
...
- Related milestone: [Tabular prediction project](../../projects/project-02-tabular-prediction/README.md)
- Suggested notebook: [First classification model](../../notebooks/03-first-classification-model.ipynb)
...
2. Complete today's task: **Compare accuracy, precision, recall, F1, and ROC-AUC**
3. Add your **Metrics notes** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 025 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 026: Decision trees](../day-026-decision-trees/README.md).
