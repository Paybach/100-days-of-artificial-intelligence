# Day 030: Supervised ML capstone

## Goal

Understand **Supervised ML capstone** and complete this practical task: **Solve a small prediction problem end to end**

Your evidence for today is: **ML project**

## Research Questions

- What problem does Supervised ML capstone solve?
...
2. Complete today's task: **Solve a small prediction problem end to end**
3. Add your **ML project** to this folder, or link to it under Artifact / Evidence.
...
- [ ] I marked Day 030 complete in [PROGRESS.md](../../PROGRESS.md).
...
Continue with [Day 031: Clustering](../day-031-clustering/README.md).
